...
import PortfolioHistory from "../component/portfolio/PortfolioHistory";
...
function Portfolio() {
  ...
  const tabs = [
    { id: 1, label: "My Portfolio", content: <MyPortfolio /> },
    { id: 2, label: "Portfolio History", content: <PortfolioHistory /> }
  ];
  return (
    <>
