      ...
      <div className="bg-white h-screen flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto ">
          <div className=" flex flex-col justify-around gap-3 m-3 relative overflow-hidden rounded-2xl shadow-lg">
            <div className="absolute z-0 -top-30 -right-10 w-48 h-48 bg-secondary rounded-full mix-blend-multiply filter blur-xl opacity-70 "></div>
            <div className="absolute z-0 -bottom-40 -left-10 w-48 h-48 bg-secondary rounded-full mix-blend-multiply filter blur-xl opacity-70 "></div>
