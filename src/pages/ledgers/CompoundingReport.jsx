...
const CompoundingReport = () => {
  ...
  const uniquecompoundingTenures = ["All", ...new Set(data.map((item) => item.compoundingTenure))];
  ...
  useEffect(() => {
    ...
    if (filters.compoundingTenure !== "All") {
      result = result.filter((item) => item.compoundingTenure === filters.compoundingTenure);
    }
      ...
      <div className="space-y-4 p-4 bg-gray-50 rounded-xl pb-20">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-4 items-end">
            ...
            <div>
              <label className="block mb-1 text-sm font-medium">compoundingTenure:</label>
              <select
                ...
                onChange={(e) => handleFilterChange("compoundingTenure", e.target.value)}
              >
