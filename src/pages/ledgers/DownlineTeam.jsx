...
const DownlineTeam = () => {
  ...
  const initialData = [
    {
      ...
      status: "Active",
      level: 1,
      currentPackageAmount: 1000
    },
    {
      id: 2,
      date: "2024-02-12",
      memberId: "M002",
      dateOfActivation: "2024-02-20",
      status: "Inactive",
      level: 2,
      currentPackageAmount: 2000
    },
    {
      id: 3,
      date: "2024-03-05",
      ...
      status: "Active",
      level: 1,
      currentPackageAmount: 1500
    },
    {
      id: 4,
      date: "2024-04-15",
      memberId: "M004",
      dateOfActivation: "2024-04-22",
      status: "Active",
      level: 3,
    ...
    },
    {
      ...
      date: "2024-06-18",
      memberId: "M006",
      dateOfActivation: "2024-06-25",
      status: "Active",
      level: 1,
      currentPackageAmount: 3500
    },
    {
      id: 7,
      date: "2024-07-20",
      memberId: "M007",
      dateOfActivation: "2024-07-28",
      status: "Inactive",
      level: 3,
    ...
    },
    {
      ...
      date: "2024-09-02",
      memberId: "M009",
      dateOfActivation: "2024-09-10",
      status: "Active",
      level: 1,
      currentPackageAmount: 1200
    },
    {
      id: 10,
      date: "2024-10-15",
      memberId: "M010",
      dateOfActivation: "2024-10-22",
      status: "Inactive",
      level: 3,
      currentPackageAmount: 2500
    }
  ...
  const uniqueLevels = ["All", ...new Set(data.map((item) => item.level))];
  ...
  useEffect(() => {
    ...
    if (filters.level !== "All") {
      result = result.filter((item) => String(item.level) === filters.level);
    }
          ...
          <table className="w-full text-sm text-left text-gray-500">
            <thead className="text-gray-700  bg-gradient-to-r from-primary to-secondary">
              <tr className="text-center whitespace-nowrap capitalize">
                ...
                <th className="px-3 py-2">memberId</th>
                <th className="px-3 py-2">dateOfActivation</th>
                <th className="px-3 py-2">level</th>
                <th className="px-3 py-2">currentPackageAmount</th>
              ...
              {paginatedData.length > 0 ? (
                paginatedData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2">{item.dateOfActivation}</td>
