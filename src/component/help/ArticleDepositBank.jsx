...
import bank1 from "../../assets/images/article/bank1.png";
import bank2 from "../../assets/images/article/bank2.png";

function ArticleDepositBank() {
        ...
        <div className="flex items-center justify-center px-4 pb-5">
          <div className=" rounded-lg p-2 max-w-2xl w-full">
            ...
            <ol className="list-decimal space-y-6 text-slate-900">
              ...
              <li className="space-y-2">
                <h2 className="text-lg font-semibold">
                  Choose Bank as Your Deposit Method
                </h2>
                <p className="text-sm text-slate-900">
                  Click on the{" "}
                  <span className="font-medium text-secondary">Bank</span> tab to
                  proceed with a Bank deposit.
                </p>
              </li>
              <li className="space-y-2">
                <h2 className="text-lg font-semibold">
              ...
              <li className="space-y-2">
                <h2 className="text-lg font-semibold">
                  Enter Bank/UTR Number & Upload Payment Receipt 
                </h2>
                <p className="text-sm text-slate-900">
                Enter Bank/UTR Number and Use the file upload option to attach your payment receipt as
...
export default ArticleDepositBank;
