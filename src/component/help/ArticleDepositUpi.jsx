...
import upi1 from "../../assets/images/article/upi1.png";
import upi2 from "../../assets/images/article/upi2.png";

function ArticleDepositUpi() {
        ...
        <div className="flex items-center justify-center px-4 pb-5">
          <div className=" rounded-lg p-2 max-w-2xl w-full">
            ...
            <ol className="list-decimal space-y-6 text-slate-900">
              ...
              <li className="space-y-2">
                <h2 className="text-lg font-semibold">
                  Choose UPI as Your Deposit Method
                </h2>
                <p className="text-sm text-slate-900">
                  Click on the{" "}
                  <span className="font-medium text-secondary">UPI</span> tab to
                  proceed with a UPI deposit.
                </p>
              </li>
              <li className="space-y-2">
                <h2 className="text-lg font-semibold">
...
export default ArticleDepositUpi;
