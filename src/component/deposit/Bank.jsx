...
import { Copy, ChevronLeft, History } from "lucide-react";
  ...
  return (
    <>
      ...
      >
        ...
        {/* Scrollable Content */}
        <div className="max-w-md  py-3 px-2 pb-20 overflow-y-auto">
          <div className="flex-1  px-3  bg-amber-50 border border-yellow-300  rounded-lg p-4 ">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          >
                            <Copy className="h-4 w-4 stroke-secondary" />
                          </button>
                        </div>
                      </div>
                      <div className="flex justify-between items-center">
